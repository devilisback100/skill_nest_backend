...
from User_data import (
    ...
    update_social_profiles, update_password  # Add this line
)
import base64
...
def update_social_profiles_route():
    ...
    result = update_social_profiles(usn, password, new_social_profiles)
    return jsonify({"status": "success", "message": result})
...
def update_password_route():
    ...
    result = update_password(usn, old_password, new_password)
    return jsonify({"status": "success", "message": result})
